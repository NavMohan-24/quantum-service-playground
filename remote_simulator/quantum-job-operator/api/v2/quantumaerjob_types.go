...
type QuantumAerJobSpec struct {
	...
	// foo is an example field of QuantumAerJob. Edit quantumaerjob_types.go to remove/update
	// +optional
...
type QuantumAerJobStatus struct {
	...
	// conditions represent the current state of the QuantumAerJob resource.
